...
- Goal planner with selectable crafting recipes, dependency paths, CWI-grounded estimates, and a persistent sequential workflow runner with play, pause, exit, and recovery controls
